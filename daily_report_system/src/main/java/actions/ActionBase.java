...
//ActionBase は、すべてのActionクラスのスーパークラスとなるクラスです。
//
//これから、従業員管理機能では EmployeeAction、日報管理機能では ReportAction というように、いくつかActionクラスを作成します。
//その際、どのActionでも必要になる処理は、スーパークラスである ActionBase で実装します。
